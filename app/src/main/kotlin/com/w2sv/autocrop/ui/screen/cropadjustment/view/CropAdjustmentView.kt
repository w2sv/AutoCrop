...
import com.w2sv.autocrop.ui.screen.cropadjustment.CropAdjustmentViewModel
import com.w2sv.autocrop.ui.screen.cropadjustment.extensions.animateMatrix
...
import com.w2sv.autocrop.ui.screen.cropadjustment.extensions.getCopy
import com.w2sv.autocrop.ui.screen.cropadjustment.extensions.getEdgeTouch
import com.w2sv.autocrop.ui.screen.cropadjustment.extensions.getInverse
import com.w2sv.autocrop.ui.screen.cropadjustment.extensions.isOnHorizontalLine
...
import com.w2sv.autocrop.ui.screen.cropadjustment.model.AnimatableRectF
import com.w2sv.autocrop.ui.screen.cropadjustment.model.DraggingState
...
class CropAdjustmentView(context: Context, attrs: AttributeSet) : View(context, attrs) {
    ...
    private val viewModel by viewModel<CropAdjustmentViewModel>()
    ...
    private fun CropAdjustmentViewModel.postCropEdges() {
        postCropEdges(
    ...
    private inner class ManualModeConfig : ModeConfig {
                    ...
                    when (draggingState) {
                        is DraggingState.DraggingEdge -> {
                            when ((draggingState as DraggingState.DraggingEdge).edge) {
                                Edge.TOP -> cropRectViewDomain.top = event.y
                                Edge.BOTTOM -> cropRectViewDomain.bottom = event.y
                            }
        ...
        private fun setMinCropRectF(draggedEdge: Edge) {
            ...
            when (draggedEdge) {
                Edge.TOP -> minCropRectViewDomain.set(
                    cropRectViewDomain.left,
                ...
                Edge.BOTTOM -> minCropRectViewDomain.set(
                    cropRectViewDomain.left,
                    cropRectViewDomain.top,
                    cropRectViewDomain.right,
        ...
        private fun setMaxCropRectF(draggedEdge: Edge) {
            ...
            when (draggedEdge) {
                Edge.TOP -> maxCropRectViewDomain.set(
                    cropRectViewDomain.left,
                    borderRect.top,
                    cropRectViewDomain.right,
                    cropRectViewDomain.bottom
                ...
                Edge.BOTTOM -> maxCropRectViewDomain.set(
                    cropRectViewDomain.left,
                    cropRectViewDomain.top,
                    cropRectViewDomain.right,
                    borderRect.bottom
