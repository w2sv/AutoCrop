...
import com.autocrop.utils.android.extensions.getSerializable
...
class CropIOService: Service() {
    ...
    private fun Intent.process(){
        cancelNotification(getSerializable(ScreenCaptureListeningService.CLOSE_NOTIFICATION_ID_EXTRA_KEY))
