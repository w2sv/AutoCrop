...
abstract class PendingIntentAssociatedResourcesCleanupService<T>(private val clientClass: Class<T>) :
    UnboundService()
    ...
    interface Client {
         ...
         */
        class BindingHandler<T>(context: Context, serviceClass: Class<T>) :
